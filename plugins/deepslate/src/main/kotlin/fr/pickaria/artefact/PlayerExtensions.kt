...
internal fun Player.getWornArtefacts(): Map<EquipmentSlot, ArtefactConfig> =
	mutableMapOf<EquipmentSlot, ArtefactConfig>().apply {
		inventory.let { inv ->
 ...
 */
internal fun Player.isWearingArtefact(artefact: ArtefactConfig): Boolean {
	inventory.let { inv ->
